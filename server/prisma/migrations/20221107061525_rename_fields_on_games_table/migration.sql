/*
  ...
  - You are about to drop the column `firstTimeCountryCode` on the `Game` table. All the data in the column will be lost.
  - You are about to drop the column `secondTimeCountryCode` on the `Game` table. All the data in the column will be lost.
